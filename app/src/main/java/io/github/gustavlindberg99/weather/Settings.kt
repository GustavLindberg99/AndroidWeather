...
class Settings : AppCompatActivity() {
        ...
        fun time(context: Context, hour: Int, minute: Int? = null): String {
            if (DateFormat.is24HourFormat(context)) {
                return String.format(
                    Locale.US,
                    if (minute == null) "%02d" else "%02d.%02d",
                    hour % 24,
                    minute
                )
            }
            ...
            val timeAsString = if (minute == null) hour12.toString()
            else String.format(
                Locale.US,
                "%d.%02d",
                hour12,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        celsius.setOnClickListener {
            preferences(this).edit().putInt(Preference.TEMPERATURE_UNIT, Preference.CELSIUS).apply()
        }
        fahrenheit.setOnClickListener {
            preferences(this).edit().putInt(Preference.TEMPERATURE_UNIT, Preference.FAHRENHEIT)
                .apply()
        }
        ...
        kmh.setOnClickListener {
            preferences(this).edit().putInt(Preference.WIND_SPEED_UNIT, Preference.KMH).apply()
        }
        ms.setOnClickListener {
            preferences(this).edit().putInt(Preference.WIND_SPEED_UNIT, Preference.MS).apply()
        }
        mph.setOnClickListener {
            preferences(this).edit().putInt(Preference.WIND_SPEED_UNIT, Preference.MPH).apply()
        }
        ...
        mm.setOnClickListener {
            preferences(this).edit().putInt(Preference.PRECIPITATION_UNIT, Preference.MM).apply()
        }
        inches.setOnClickListener {
            preferences(this).edit().putInt(Preference.PRECIPITATION_UNIT, Preference.INCHES)
                .apply()
        }
        ...
        americanAqi.setOnClickListener {
            preferences(this).edit().putInt(Preference.AIR_QUALITY_INDEX, Preference.AMERICAN_AQI)
                .apply()
        }
        europeanAqi.setOnClickListener {
            preferences(this).edit().putInt(Preference.AIR_QUALITY_INDEX, Preference.EUROPEAN_AQI)
                .apply()
        }
        ...
        this.findViewById<Button>(R.id.help_button).setOnClickListener {
            val browserIntent = Intent(
                Intent.ACTION_VIEW,
                Uri.parse("https://github.com/GustavLindberg99/AndroidWeather/blob/master/README.md")
            )
        ...
        this.findViewById<Button>(R.id.feedback_button).setOnClickListener {
            val browserIntent = Intent(
                Intent.ACTION_VIEW,
                Uri.parse("https://github.com/GustavLindberg99/AndroidWeather/issues")
            )
            startActivity(browserIntent)
        }
        this.findViewById<Button>(R.id.about_button).setOnClickListener {
            ...
            textView.text = HtmlCompat.fromHtml(
                String.format(
                    this.getString(R.string.about_string),
                    BuildConfig.VERSION_NAME,
                    "https://github.com/GustavLindberg99/AndroidWeather",
                    "https://open-meteo.com/",
                    "https://github.com/GustavLindberg99/AndroidWeather/blob/master/LICENSE"
